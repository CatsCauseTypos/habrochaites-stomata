...
# trialB_ad_scatter.png 800 aspect ratio
...
ggplot(Trial_b, aes(reorder(Treatment), y = Index_ad, x = Geno, fill = Treatment))+
  ...
  theme(plot.title = element_text(lineheight=.8,hjust = 0.5, face="bold", size = 28),
        axis.title.x = element_text(face="bold", size=20, vjust = -0.5, margin = margin(t= 10 , r = 0, b = 2, l = 0)),
        axis.title.y = element_text(
          face="bold", size=18, 
          margin = margin(t = 0, r = 10, b = 0, l = 1)),
