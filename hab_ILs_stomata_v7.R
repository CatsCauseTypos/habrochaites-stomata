...
data01 <- read.csv("~/Desktop/Sinha Lab stuff/Hab IL stomatal stuff/plswork.csv") # the same file with hand-annotated significance
...
data3 <- read.csv("~/Desktop/Sinha Lab stuff/Hab IL stomatal stuff/hab_stats_R_useful_categ.csv", stringsAsFactors=TRUE) # file back in
