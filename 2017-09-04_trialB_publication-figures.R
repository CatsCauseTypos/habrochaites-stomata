...
# Bar graph adaxial stomata (done) ----
...
# bar plot stomatal index adaxial (done) ----
...
# bar graph AB pave w sig. (check stats; otherwise done) ----
...
# bar AB Stom w significance (done)  ----
...
# bar AB Index w significance (done) ----
